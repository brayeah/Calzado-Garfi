...
class GaleriaController extends Controller {
   ...
   public function index(Request $request)
   {
    $productos = Producto::all();
          $productos=Producto::Search($request->estilo) ->orderBy('estilo', 'DESC')->paginate(20);
        

        return view('galeria.index',compact('productos'));
...
return redirect('productos');
   ...
   return view('galeria.show',compact('productos'));
   }
