...
@media all and (min-width: 700px) {
  ...
  nav#nav-movil {
    ...
    <Center> <figure class="contenedor">  <a href=""><img src="{{ asset('contenido/nombregarfi.png') }}" style="position:relative; top:-22px; border="0"></a>
   
    <!-- Nav -->
    
 

    <div style="position: relative; top:-22px; z-index: 5;">
    ...
    <div id="header">
        ...
        <li><a href="{{ url('/galeria') }}">Tienda En Línea</a></li>    
             ...
             <li><a href="{{ url('productos') }}">Admin</a>
             <ul>
        ...
        <li><a href="{{ url('productos') }}">Admin</a></li>
        <li><a href="#" data-toggle="modal" data-target="#contactanos">Contáctanos</a></li>

         </nav>
     </figure></center>
    
 <figure class="app-facebook"><p style="text-align: right; "><a href=https://www.facebook.com/garfi.kids.3 target="_blank"><img alt="siguenos en facebook" src="http://2.bp.blogspot.com/-GlLV_MydcBk/UiX09MYOSfI/AAAAAAAAB18/5vkDADo6qEw/s1600/Facebook+alt+1.png" title="siguenos en facebook" /></a>

<a href=https://twitter.com/CalzadoGarfi target="_blank"><img alt="siguenos en Twitter" src="http://3.bp.blogspot.com/-sbO3cK5dmzo/UiX1BG6KASI/AAAAAAAAB2s/wYYv24Dpggw/s1600/Twitter+alt+4.png" title="siguenos en Twitter" /></a>
 <a href=https://www.youtube.com/channel/UCGtojLGkLSNRdLuJ1S8Q-pQ?view_as=subscribertarget= target="_blank"><img alt="Canal de youtube" src="http://1.bp.blogspot.com/-nFaU3lAbBgg/UiX1C-m6KjI/AAAAAAAAB3M/Lbf9N4I9QOg/s1600/Youtube+alt+2.png" title="Canal de youtube" /></a>


<a href=http://Instagram.com/ target="_blank"><img alt="sígueme en Instagram" src="http://1.bp.blogspot.com/-P6il8-oOBvw/UiYMOJYxK9I/AAAAAAAAB9o/HLUAnsDoor4/s1600/instagram.png" title="sígueme en Instagram" /></a>


<a href="mailto:calzadogarfi@hotmail.com" target="_blank"><img alt="Envianos un Correo" src="http://3.bp.blogspot.com/-JrNncKvJUnY/Uid1UFUg_0I/AAAAAAAACBs/ygQ9cfdi8Vw/s1600/correo.png" title="Envianos un Correo" /></a>
</p>
</figure>
    ...
    <div style="position: relative; top:-25px;"> <video  src="{{ asset('contenido/kids.mp4') }}" width="1400" height="650" autoplay muted controls loop></video> </div>



     <div style="text-align:center;" class='define' >
     <div  class='define'> <br><br><br>
        ...
        <li><a href="#" data-toggle="modal" data-target="#telefono">Teléfono</a></li>
        <li><a target="_blank" href="https://www.google.com.mx/maps/place/Melchor+Ocampo+606,+INFONAVIT+San+Francisco,+36330+San+Francisco+del+Rinc%C3%B3n,+Gto./@21.0232521,-101.8532322,17z/data=!4m13!1m7!3m6!1s0x842be84e2409c8ad:0x62e92018a64dc5be!2sMelchor+Ocampo+606,+INFONAVIT+San+Francisco,+36330+San+Francisco+del+Rinc%C3%B3n,+Gto.!3b1!8m2!3d21.0232521!4d-101.8510435!3m4!1s0x842be84e2409c8ad:0x62e92018a64dc5be!8m2!3d21.0232521!4d-101.8510435" >Ubicación</a></li>
        <li><a href="#" data-toggle="modal" data-target="#politicas">Políticas</a></li>
